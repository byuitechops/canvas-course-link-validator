...
Promise
    ...
    .then((courseListAndDetails) => {
        ...
        //Returns an array of course objects with keys: id, name, courseCode, link, publishedBrokenLinksCount, brokenLinksCount, message, and lastRun.
