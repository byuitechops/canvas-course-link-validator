...
Promise
    ...
    .then((arrayWithCourseIdsAndBoundaryDate) => {
        var courseIdList = arrayWithCourseIdsAndBoundaryDate[0].slice(0, 3); //TODO: WILL NEED TO GET RID OF THE SLICE
...
//TODO: Debug, the account section here (make sure the changes to main (only runing the get api sometimes didn't ruin anything))