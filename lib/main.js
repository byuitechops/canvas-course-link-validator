...
module.exports = function main(courseId, boundaryDate, courseName) {
    ...
    function putTogetherBrokenLinksObject(courseName, linkValidationInfo) {
        return {
            ...
            message: linkValidationInfo.workflow_state, //This could be changed to the message key of the linkValidationInfo object. I wasn't sure which key would be the most relevant to contain an error message.
