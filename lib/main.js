...
module.exports = function main(courseId, boundaryDate, courseObject) {
    ...
    return Promise.all(promisesToRun)
        .then((inputObject) => {
            ...
            return new Promise((resolve, reject) => {
                //The !linkValidationInfo.create_at checks to see if the link validator has ever been run.
    ...
    /***********************************************
     * wait
     * @param secIn the number of seconds you want the function to wait for before it returns a promise.
     * 
     * @returns a promise after the time specified.
     ***********************************************/
    function wait(secIn) {
     ...
     * @param timedOut (a boolean that lets us know if we have timed out when polling or not)
     * 
